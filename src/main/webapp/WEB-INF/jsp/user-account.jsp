...
<button class="btn btn-primary btn-lg" data-toggle="modal"
	data-target="#myModal">New project</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">Days to
							start:</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">Links to
							video about project:</label>
						<div class="col-sm-10">
...
<table class="table table-bordered table-hover table-striped">
	...
	<tbody>
		<c:forEach items="${projects}" var="project">
			<tr>
				<td><strong> <a
						href="<spring:url value="/project/${project.id}.html" />">
							${project.name} </a>
				...
				<td><a
					href="<spring:url value="/project/remove/${project.id}.html" />"
					class="btn btn-danger triggerRemove">remove project</a></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
<center><strong>My Rewards</strong></center>
<table class="table table-bordered table-hover table-striped">
	<thead>
		<tr>
			<th>Amount</th>
...
<c:forEach items="${user.rewards}" var="userreward">
	<tbody>
		<tr>
			<td><c:out value="$${userreward.amount}" /></td>
			<td><c:out value="${userreward.description}" /></td>
			<td><a href="<spring:url value="/project/${userreward.project.id}.html" />">
						${userreward.project.name}
					</a></td>
		</tr>
	</tbody>
</c:forEach>
